...
const Login = () => {
  ...
  return (
    <div className="flex justify-center items-center h-screen bg-cover bg-center" style={{ backgroundImage: `url('https://i.pinimg.com/564x/60/89/dd/6089dd54a4e5c395e08afe3de7257fed.jpg')` }}>
      {loading && <Loader />}
      {/* Login Form  */}
